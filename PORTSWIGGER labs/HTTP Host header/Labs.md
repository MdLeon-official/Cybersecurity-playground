...
```
Go to https://0a4600590401413980a40d4d001a00a0.web-security-academy.net//forgot-password?temp-forgot-password-token=y8ntm0p7fd4v2o8lo6tsak86op8eavx7 and then you can enter a new password -> then login as carlos
